...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setLoading(true);
    try {
      const r = await login({ username: formData.identifier, password: formData.password, remember_me: rememberMe });
      if (r.success) navigate('/dashboard', { replace: true });
  ...
  return (
    <div className="min-h-[100dvh] flex flex-col items-center justify-center px-4 bg-gray-50 dark:bg-gray-950">
